...
const linksByGroup={
 ...
 Teacher:[L("/admin","الرئيسية","Home"),L("/admin/exams","اختبارات مقرراتي","My Course Exams"),L("/admin/registrations","تسجيل طلاب الشُّعب","Section Registration"),L("/admin/education/reports","تحليل النتائج","Results Analytics")],
